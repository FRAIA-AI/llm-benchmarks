...
# =========================================================
export CLINICAL_CONCURRENCY_OVERRIDE="4"
export PHASE_NAME="clinical_c4"

echo ">>> STARTING PHASE 2: CLINICAL NOTES (CONCURRENCY=$CLINICAL_CONCURRENCY_OVERRIDE)"
...
echo ">>> STARTING PHASE 3: CLINICAL NOTES (CONCURRENCY=$CLINICAL_CONCURRENCY_OVERRIDE)"
...
# =========================================================
# PHASE 4: CLINICAL NOTES (SingleGPU)
# =========================================================
export CLINICAL_CONCURRENCY_OVERRIDE="16"
export PHASE_NAME="clinical_gpu1_c16"

echo ">>> STARTING PHASE 4: CLINICAL NOTES Single GPU (CONCURRENCY=$CLINICAL_CONCURRENCY_OVERRIDE)"
